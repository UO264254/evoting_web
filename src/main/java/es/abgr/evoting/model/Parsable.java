...
import es.abgr.evoting.exceptions.CSTException;
...
public class Parsable implements Serializable {
	 ...
	 * @throws PEException 
	 */
	public static Parsable fromB64(String b64, String sender) throws CSTException {
		Parsable obj = null;
		...
		try {
			...
			throw new CSTException("La cadena " + b64 + " enviada por " + sender + " no puede ser interpretada", e);
		}
