...
public class Constants {
	...
	public static int accessTokenLength = 15;
	
	public static int activationTokenLength = 5;
	...
	public static final String ERROR_YA_VOTADO = "ERROR_YA_VOTADO";

	public static final String ERROR_PROCESO_CERRADO = "ERROR_PROCESO_CERRADO";

	public static final String ERROR_PROCESO = "ERROR_PROCESO";

	public static final String USUARIO_YA_EXISTE = "USUARIO_YA_EXISTE";
	
	public static final String ERROR_MAXPREFERENCES = "ERROR_MAXPREFERENCES";

	public static final String USUARIO_OBLIGATORIO = "USUARIO_OBLIGATORIO";
}
