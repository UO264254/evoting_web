...
public class RSA_OAEP {
	 ...
	 * @throws PEException
	 */
	public static String encrypt(byte[] message, Key key, boolean flag) throws ENCException {
	 ...
	 * @throws PEException
	 */
	public static byte[] decrypt(String cipherText, Key key, boolean flag) throws ENCException {
		Security.addProvider(new org.bouncycastle.jce.provider.BouncyCastleProvider());
