...
public class HMAC {
	...
	private static SecretKey keyGen(String password, byte[] salt) throws ENCException {
		...
		try {
			...
			throw new ENCException("Error HMAC", e);
		}
	}
	
	private static String computeHMAC(String[] message, String password, byte[] salt) throws ENCException {
	...
	public static void sign(VotePacket packet, String password) throws ENCException {
	...
	public static boolean verify(VotePacket packet, String password) throws ENCException {
